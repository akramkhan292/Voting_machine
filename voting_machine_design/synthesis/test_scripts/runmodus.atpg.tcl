...
build_model \
    ...
    -designsource	 $WORKDIR/voting_machine.test_netlist.v \
...
build_testmode \
    -testmode	 FULLSCAN \
    -assignfile	 $WORKDIR/voting_machine.FULLSCAN.pinassign \
    -modedef	 FULLSCAN \
...
#-------------------------------------------------------------------------------
create_logic_tests \
    -experiment	 voting_machine_atpg \
    -testmode	 FULLSCAN \

check_log log_create_logic_tests_FULLSCAN_voting_machine_atpg
...
#-------------------------------------------------------------------------------
write_vectors \
    -inexperiment	 voting_machine_atpg \
    -testmode	 FULLSCAN \
    -language	 verilog \
    -scanformat	 parallel \

check_log log_write_vectors_FULLSCAN_voting_machine_atpg
...
check_log log_commit_tests_FULLSCAN_voting_machine_atpg
