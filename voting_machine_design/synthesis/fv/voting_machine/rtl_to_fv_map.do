...
# Generated on: Thu Jul 18 12:56:51 IST 2024 (Thu Jul 18 07:26:51 UTC 2024)
...
set logfile fv/voting_machine/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/voting_machine -revised fv_map
...
read_library -liberty -both \
    /home/nilet/akram/voting_machine/counter_design_database_45nm/synthesis/../lib/slow_vdd1v0_basicCells.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  ../rtl/voting_machine.v
elaborate_design -golden -root {voting_machine} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/voting_machine/fv_map.v.gz
elaborate_design -revised -root {voting_machine}
...
#add_name_alias fv/voting_machine/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.voting_machine.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.voting_machine.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.voting_machine.rtl.fv_map.rpt
